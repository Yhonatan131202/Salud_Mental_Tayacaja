...
<head>
    ...
    <title>EDITAR USUARIO-psicologos</title>
</head>
<body>
    <?php
     $Id_Psicologos = isset($_GET['Id_Psicologos']) ? $_GET['Id_Psicologos'] : '';
    ...
    ?>
<div>
    <form action="../../modelo/editarPsicologosNuevo.php" method="post" enctype="multipart/form-data">
        <table>
            <tr>
                <td>Ingresar Datos:</td>
                <td><input type="TEXT" name="Id_Psicologos" id="" value="<?=$Id_Psicologos?>"></td>
            </tr>
            <tr>
                <td>Foto:</td>
